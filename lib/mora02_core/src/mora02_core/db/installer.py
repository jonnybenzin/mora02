...
Usage:
    ...
    python -m mora02_core.db.installer

    # Or programmatically:
    from mora02_core.db.installer import export_schema
...
log = get_logger("mora02_core.db.installer")
...
async def export_schema(
    *,
    ...
    """Regenerate ``mora02_core/db/schema.py`` from a live Baserow instance.
    ...
    lines: list[str] = [
        ...
        "",
        f"Generated by mora02_core.db.installer.export_schema() at {ts}.",
...
def main() -> None:
    """CLI entry point for `python -m mora02_core.db.installer`."""
    import asyncio
